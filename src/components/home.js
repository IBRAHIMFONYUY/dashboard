    ...
    return(
        ...
        <div className='graph-cnt-1'>
            ...
            <div className="sub-graph-cnt-1">
                <div className="sub-graph-1"><div className="sub-graph-1-content">Total Users</div></div>
                <div className="sub-graph-2"><div className="sub-graph-1-content">Total Users</div></div>
            </div>
        </div>
        <div className="graph-cnt-2"><div className="bar-chart">
        <div className="user-lg"><h1>Traffic</h1>January 01, 2023 - December 31, 2023</div>
